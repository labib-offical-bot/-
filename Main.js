...
global.channelLink = "https://whatsapp.com/channel/0029VbCq73M6mYPRCwC3zQ0p";
global.ytch = "labib vaiya";
...
async function handleMessages(sock, messageUpdate, printLog) {
    try {
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029VbCq73M6mYPRCwC3zQ0p'
                }, { quoted: message });
                return;
        ...
        const adminCommands = ['.mute', '.unmute', '.ban', '.unban', '.promote', '.demote', '.kick', '.tagall', '.tagnotadmin', '.antispam', '.antilink', '.antitag', '.setgdesc', '.setgname', '.setgpp'];
